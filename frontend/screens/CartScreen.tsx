        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {items.length === 0 ? (
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptySubtitle}>Start learning by adding some courses to your cart</Text>
...
const styles = StyleSheet.create({
    ...
    button: { backgroundColor: "#3B82F6", padding: 12, borderRadius: 8, marginTop: 16, alignItems: "center" },
    buttonText: { color: "#fff", fontWeight: "700" },
    item: { flexDirection: "row", marginBottom: 16, borderWidth: 1, borderColor: "#E5E7EB", borderRadius: 8, padding: 8 },
    ...
    summary: { marginTop: 16, borderWidth: 1, borderColor: "#E5E7EB", borderRadius: 8, padding: 16 },
